...
def export_vegas(chunk_name, music_files, sound_files):
    ...
    # Split file lists and check existence
    music_file_list = music_files.split(',')
    sound_file_list = sound_files.split(',')
    all_files = music_file_list + sound_file_list
    ...
    if response_sounds:
        ...
        if match:
            ...
            for line in lines[1:]:
                if ',' in line:
                    position, name = line.split(',', 1)  # Переименовал time на position
...
if __name__ == "__main__":
    if len(sys.argv) < 4:
        ...
        print("Example: python src/core/export_vegas.py chunk_1_sol_6_7 \"output/chunk_1_sol_6_7/music_analysis/part1.txt,output/chunk_1_sol_6_7/music_analysis/part2.txt\" \"output/chunk_1_sol_6_7/sounds_analysis/part1.txt,output/chunk_1_sol_6_7/sounds_analysis/part2.txt\"")
        sys.exit(1)
